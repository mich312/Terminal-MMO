...
| `A` | **Arcade** | A neon hall of cabinets, each a portal into a minigame (Sokoban, Maze, Snake, Tetris, Pong, Breakout, Bomberman, 2048). Out west past Kraftwerk; also off the lobby. See [`AREAS.md`](AREAS.md). |
