...
var propArt = map[TileProp][]string{
	...
	PropStalagmite: { // a rock spire rising from the floor, lit point, dark base
		"..L...",
		"..L...",
		".LPp..",
		".PPp..",
	...
	PropColumn: { // a floor-to-ceiling pillar, banded with flowstone folds
		".LPpL.",
		".PPpp.",
		".LPpL.",
		".PPpp.",
	...
	PropTimbering: { // old mine support timbers: two posts and a head beam
		"TTTTTT",
		"T....T",
		"T....T",
		"T....T",
	...
	PropRelic: { // a half-buried relic, faintly aglow under the dust
		"..GG..",
		".GWWG.",
		"GWLLWG",
		".GWWG.",
