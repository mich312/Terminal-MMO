...
// creatureArt holds detailed side-view animal sprites for the HD renderer. They
// are higher-resolution than the 6×6 props (12 art-pixels across a tile, the
// avatar's density) and bottom-aligned within the tile, so wildlife reads as a
// proper little figure rather than a blob. Drawn by drawCreature; the glyph
// client still shows the species letter. Codes match the prop palette:
//
//	P body   p shade   o outline   L light   W highlight   D dark   . clear
//	e eye (dark)   n nose/muzzle (light)
var creatureArt = map[TileProp][]string{
	PropRabbit: {
		".......o....",
		"......oPo...",
		".o....oPo...",
